...
|---|---|---
| [A24 Films](https://github.com/hafsahsiddiqui/sql-projects/tree/730296e84a8dec3ce04daab1f0a9378b86596154/A24%20Films)| I wrote SQL queries that allowed me to quickly explore, analyze, and gain insights about the filmography of A24 films such as ratings, directors, box office performance, and more using a dataset | Excel <br> SQL <br> Tableau
...
| Lone Star Clean Fuels Alliance | We developed and delivered a customized Monday.com CRM system for Lone Star Clean Fuels Alliance, enabling streamlined cloud-based management of client contacts with multi-level user access and comprehensive support materials. The project included thorough testing, data migration, and user training to ensure a smooth transition and long-term system usability. | [Report](https://drive.google.com/drive/folders/1IvOmT5QuyiVJzAQTg-i7E0odXnPZEPv0?dmr=1)  <br> [Project Summary](https://docs.google.com/document/d/1R6Jbwz1REjfq2yUx15M8R-AUk9dBl7toeLhia-SEw2c/edit) <br> [Slide Deck](https://docs.google.com/presentation/d/1n64v2n6GHsWGwjyi65S97i6U78RAMn52Thx_FtjNaFU/edit#slide=id.p) |
