...
| 8 Weeks SQL Challenge | I tried tackling the 8 case studies from the [8 Weeks SQL Challenge](https://8weeksqlchallenge.com/). I wanted to demonstrate my SQL query writing and problem-solving skills more | SQL
